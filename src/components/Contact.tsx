    ...
    <div className="container-fluid mt-5 cont-flu">
      <div className="container contact-div mt-5">
        <div className="row align-content-center py-5">
          ...
          <div className="col-lg-3 col-md-3 col-sm-12">
            ...
            <div className="cont-card mx-auto">
              ...
              <a href="https://www.instagram.com/"><div className="box box1"><span className="icon"><svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" className="svg">
        ...
        <div className="row text-center mt-3">
          <div className="col">
            <p style={{color:'rgb(85,85,85)', fontSize:'14px'}}>Copyright 2023 <span style={{color:'#32a83e'}}> Dscode </span> | All rights reserved</p>
          </div>
        </div>
      </div>
      </div>
